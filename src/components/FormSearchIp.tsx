...
export default function FormSearchIp() {
    ...
    return (
        <div className="bg-cover bg-center w-4/5 md:w-11/12 m-auto h-96 flex flex-col justify-center items-center gap-10 bg-fixed mt-10" style={{ backgroundImage: "url('https://images.pexels.com/photos/1597776/pexels-photo-1597776.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')" }}>
            ...
            <form className="flex flex-col justify-center md:w-full items-center gap-2 md:content-normal" onSubmit={handleSubmit}>
                <div className="flex flex-col md:flex-row h-24 justify-center items-center gap-4 md:w-2/4">
                    <input type="text" onChange={handleChangeInput} value={valueInput} className="rounded-md w-full md:w-9/12 h-2/5 px-2" placeholder="Ej: 237.84.2.178" />
                    <button className="bg-yellow-500 px-4 py-2 font-semibold rounded-md w-full md:w-1/4">Buscar &nbsp;<PushpinOutlined /></button>
                </div>
