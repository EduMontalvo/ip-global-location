...
export default function IndexPage() {
    ...
    return (
        <>
            ...
            <div className="flex flex-col md:flex-row gap-4 w-4/5 md:w-11/12 md:justify-center items-center md:mt-10 m-auto">
                <div
                    className="bg-contain bg-no-repeat bg-center my-5 rounded-xl h-56 bg-yellow-400 w-full md:w-3/6 md:order-2"
                    style={{ backgroundImage: "url('https://svgsilh.com/svg/2750411.svg')" }}
                >
                </div>
                <div className="text-white flex flex-col gap-4 md:w-3/6 md:order-1 md:px-4">
